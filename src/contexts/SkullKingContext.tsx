       ...
       try {
         ...
         for (const key of gameKeys) {
           ...
           if (stored) {
             ...
             // Only return unfinished games (currentRound <= cardsPerRound.length means game is still ongoing)
             // When game is finished, currentRound = cardsPerRound.length + 1 (set by finishGame())
